...
pdfsetA=["nNNPDF30_nlo_as_0118_A208_Z82","nNNPDF30_nlo_as_0118_p_Pb208"]

# Baseline PDFs in proton
pdfsetP=["nNNPDF30_nlo_as_0118_p","nNNPDF30_nlo_as_0118_p"]

# The PDF set labels
#pdfsetlab=[r"${\rm nNNPDF3.0}~\left(\widetilde{R}_f^{({\rm Fe})}\right)$",\
#           r"${\rm nNNPDF3.0}$"]
pdfsetlab=[r"${\rm nNNPDF3.0}~\left(\widetilde{R}_f^{({\rm Pb})}\right)$",\
            r"${\rm nNNPDF3.0}$"]

q = 10 # GeV
error_option=["mc_90cl","mc_90cl"]
#filelabel="-neutrinoPDFs_Fe_q10gev"
filelabel="-neutrinoPDFs_Pb_q10gev"
...
# pdflabels
#labelpdf=[r"$R^{\rm (Fe)}_{u}(x,Q)$",r"$R^{\rm (Fe)}_{d}(x,Q)$",r"$R^{\rm (Fe)}_{\Sigma}(x,Q)$",\
#          r"$R^{\rm (Fe)}_{\bar{u}}(x,Q)$",r"$R^{\rm (Fe)}_{\bar{d}}(x,Q)$",r"$R^{\rm (Fe)}_{ g}(x,Q)$"]
labelpdf=[r"$R^{\rm (Pb)}_{u}(x,Q)$",r"$R^{\rm (Pb)}_{d}(x,Q)$",r"$R^{\rm (Pb)}_{\Sigma}(x,Q)$",\
          r"$R^{\rm (Pb)}_{\bar{u}}(x,Q)$",r"$R^{\rm (Pb)}_{\bar{d}}(x,Q)$",r"$R^{\rm (Pb)}_{ g}(x,Q)$"]
