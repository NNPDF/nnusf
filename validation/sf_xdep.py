...
# Neutrino
yadism_f2_nnlo_nu_p = np.loadtxt(
    "../pdfs_lo/Yadism_data_v2/neutrino/NNLO/predictions/F2.txt"
)
yadism_xf3_nnlo_nu_p = np.loadtxt(
    "../pdfs_lo/Yadism_data_v2/neutrino/NNLO/predictions/F3.txt"
)
yadism_fl_nnlo_nu_p = np.loadtxt(
    "../pdfs_lo/Yadism_data_v2/neutrino/NNLO/predictions/FL.txt"
)

# Anti-neutrino
yadism_f2_nnlo_nubar_p = np.loadtxt(
    "../pdfs_lo/Yadism_data_v2/antineutrino/NNLO/predictions/F2.txt"
)
yadism_xf3_nnlo_nubar_p = np.loadtxt(
    "../pdfs_lo/Yadism_data_v2/antineutrino/NNLO/predictions/F3.txt"
)
yadism_fl_nnlo_nubar_p = np.loadtxt(
    "../pdfs_lo/Yadism_data_v2/antineutrino/NNLO/predictions/FL.txt"
)
    ...
    for ix in range(nx_yadism):
        for iq in range(nq_yadism):
            ...
            if iq == iq_yadism:
                ...
                # Now fill
                if irep > 0:
                    yadism_nnlo_f2_nu[irep - 1][ix] = yadism_f2_nnlo_nu_p[
                        icount
                    ][3]
                    yadism_nnlo_xf3_nu[irep - 1][ix] = yadism_xf3_nnlo_nu_p[
                        icount
                    ][3]
                    yadism_nnlo_fl_nu[irep - 1][ix] = yadism_fl_nnlo_nu_p[
                        icount
                    ][3]
                    yadism_nnlo_f2_nubar[irep - 1][ix] = yadism_f2_nnlo_nubar_p[
                        icount
                    ][3]
                    yadism_nnlo_xf3_nubar[irep - 1][
                        ix
                    ] = yadism_xf3_nnlo_nubar_p[icount][3]
                    yadism_nnlo_fl_nubar[irep - 1][ix] = yadism_fl_nnlo_nubar_p[
                        icount
                    ][3]
...
yadism_nnlo_f2_nu_mid = (yadism_nnlo_f2_nu_high + yadism_nnlo_f2_nu_low) / 2.0
yadism_nnlo_f2_nu_error = (yadism_nnlo_f2_nu_high - yadism_nnlo_f2_nu_low) / 2.0
...
yadism_nnlo_f2_nubar_mid = (
    yadism_nnlo_f2_nubar_high + yadism_nnlo_f2_nubar_low
) / 2.0
yadism_nnlo_f2_nubar_error = (
    yadism_nnlo_f2_nubar_high - yadism_nnlo_f2_nubar_low
) / 2.0
...
yadism_nnlo_fl_nu_mid = (yadism_nnlo_fl_nu_high + yadism_nnlo_fl_nu_low) / 2.0
yadism_nnlo_fl_nu_error = (yadism_nnlo_fl_nu_high - yadism_nnlo_fl_nu_low) / 2.0
...
yadism_nnlo_fl_nubar_mid = (
    yadism_nnlo_fl_nubar_high + yadism_nnlo_fl_nubar_low
) / 2.0
yadism_nnlo_fl_nubar_error = (
    yadism_nnlo_fl_nubar_high - yadism_nnlo_fl_nubar_low
) / 2.0
...
yadism_nnlo_xf3_nu_mid = (
    yadism_nnlo_xf3_nu_high + yadism_nnlo_xf3_nu_low
) / 2.0
yadism_nnlo_xf3_nu_error = (
    yadism_nnlo_xf3_nu_high - yadism_nnlo_xf3_nu_low
) / 2.0
...
yadism_nnlo_xf3_nubar_mid = (
    yadism_nnlo_xf3_nubar_high + yadism_nnlo_xf3_nubar_low
) / 2.0
yadism_nnlo_xf3_nubar_error = (
    yadism_nnlo_xf3_nubar_high - yadism_nnlo_xf3_nubar_low
) / 2.0
...
pdfset = ["YADISM_208", "NNUSF10_A56_Q2MIN001", "NNUSF10_A208_Q2MIN001"]
...
for ifl in range(nfl):
    ...
    if ifl == 0:
        ...
        ax.fill_between(
            yadism_sf_x,
            yadism_nnlo_f2_nu_high,
            yadism_nnlo_f2_nu_low,
            color=rescolors[3],
            alpha=0.2,
        )
    ...
    if ifl == 1:
        ...
        ax.fill_between(
            yadism_sf_x,
            yadism_nnlo_fl_nu_high,
            yadism_nnlo_fl_nu_low,
            color=rescolors[3],
            alpha=0.2,
        )
        p8 = ax.fill(np.NaN, np.NaN, color=rescolors[3], alpha=0.2)
    if ifl == 2:
        ...
        ax.fill_between(
            yadism_sf_x,
            yadism_nnlo_xf3_nu_high,
            yadism_nnlo_xf3_nu_low,
            color=rescolors[3],
            alpha=0.2,
        )
        p8 = ax.fill(np.NaN, np.NaN, color=rescolors[3], alpha=0.2)
    ...
    if ifl == 3:
        ...
        ax.fill_between(
            yadism_sf_x,
            yadism_nnlo_f2_nubar_high,
            yadism_nnlo_f2_nubar_low,
            color=rescolors[3],
            alpha=0.2,
        )
        p8 = ax.fill(np.NaN, np.NaN, color=rescolors[3], alpha=0.2)
    if ifl == 4:
        ...
        ax.fill_between(
            yadism_sf_x,
            yadism_nnlo_fl_nubar_high,
            yadism_nnlo_fl_nubar_low,
            color=rescolors[3],
            alpha=0.2,
        )
        p8 = ax.fill(np.NaN, np.NaN, color=rescolors[3], alpha=0.2)
    if ifl == 5:
        ...
        ax.fill_between(
            yadism_sf_x,
            yadism_nnlo_xf3_nubar_high,
            yadism_nnlo_xf3_nubar_low,
            color=rescolors[3],
            alpha=0.2,
        )
        p8 = ax.fill(np.NaN, np.NaN, color=rescolors[3], alpha=0.2)
    ...
    if ifl == 6:
        p7 = ax.plot(
            yadism_sf_x,
            (yadism_nnlo_f2_nu_mid + yadism_nnlo_f2_nubar_mid) / 2,
            ls="dashdot",
            color=rescolors[3],
            lw=2,
        )
        ax.fill_between(
            yadism_sf_x,
            (yadism_nnlo_f2_nu_high + yadism_nnlo_f2_nubar_high) / 2,
            (yadism_nnlo_f2_nu_low + yadism_nnlo_f2_nubar_low) / 2,
            color=rescolors[3],
            alpha=0.2,
        )
        p8 = ax.fill(np.NaN, np.NaN, color=rescolors[3], alpha=0.2)
    ...
    if ifl == 7:
        p7 = ax.plot(
            yadism_sf_x,
            (yadism_nnlo_fl_nu_mid + yadism_nnlo_fl_nubar_mid) / 2,
            ls="dashdot",
            color=rescolors[3],
            lw=2,
        )
        ax.fill_between(
            yadism_sf_x,
            (yadism_nnlo_fl_nu_high + yadism_nnlo_fl_nubar_high) / 2,
            (yadism_nnlo_fl_nu_low + yadism_nnlo_fl_nubar_low) / 2,
            color=rescolors[3],
            alpha=0.2,
        )
        p8 = ax.fill(np.NaN, np.NaN, color=rescolors[3], alpha=0.2)
    ...
    if ifl == 8:
        p7 = ax.plot(
            yadism_sf_x,
            (yadism_nnlo_xf3_nu_mid + yadism_nnlo_xf3_nubar_mid) / 2,
            ls="dashdot",
            color=rescolors[3],
            lw=2,
        )
        ax.fill_between(
            yadism_sf_x,
            (yadism_nnlo_xf3_nu_high + yadism_nnlo_xf3_nubar_high) / 2,
            (yadism_nnlo_xf3_nu_low + yadism_nnlo_xf3_nubar_low) / 2,
            color=rescolors[3],
            alpha=0.2,
        )
        p8 = ax.fill(np.NaN, np.NaN, color=rescolors[3], alpha=0.2)
    ...
    if ifl == 3:
        ax.legend(
            [(p1[0], p2[0]), (p7[0], p8[0]), (p3[0], p4[0]), (p5[0], p6[0])],
