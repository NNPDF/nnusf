...
pdfset=["NNPDF31sx_nlo_as_0118_nf_6","NNPDF31sx_nlo_as_0118_LHCb_nf_6","nNNPDF30_nlo_as_0118_p_iso","nNNPDF30_nlo_as_0118_p"]
    ...
    if(ifl==1):
        ax.legend([(p1[0],p2[0]),(p3[0],p4[0]),(p5[0],p6[0]),(p7[0],p8[0])],\
                  ["NNPDF31sx\_nlo\_as\_0118\_nf\_6",\
                   ...
                   "nNNPDF30\_nlo\_as\_0118\_p\_iso",\
...
py.savefig('PDFvalidation-'+filelabel+'.pdf')
print('output plot: PDFvalidation-'+filelabel+'.pdf')
...
for ifl in range(nfl):
    ...
    if(filelabel=="q100gev"):
        if(ifl==0): ax.set_ylim(0.8,1.2)
        if(ifl==1): ax.set_ylim(0.8,1.2)
    if(filelabel=="q2p0gev"):
...
py.tight_layout(pad=1, w_pad=1, h_pad=1.0)
py.savefig('PDFvalidation-ratio-'+filelabel+'.pdf')
print('output plot: PDFvalidation-ratio-'+filelabel+'.pdf')
